...
def display_license(): 
    print(""" 
BLOCKCHAIN_VOTING_SYSTEM Copyright (C) 2024 Ashutosh Pawar. This program comes with ABSOLUTELY NO WARRANTY; for details type `show w`. This is free software, and you are welcome to redistribute it under certain conditions; type `show c` for details. [GNU General Public License Version 3, 29 June 2007] For full details, visit: https://www.gnu.org/licenses/gpl-3.0.en.html 
""") 
display_license()
